...
class ook(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Transmisor OOK")
        ...
        self.qtgui_time_sink_x_0.set_font_size(8) # Adjust font size if needed for better display
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 1e7, 2, 0)

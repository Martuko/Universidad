# ventanas/caja.py
from PyQt5.QtWidgets import QWidget, QVBoxLayout, QLineEdit, QLabel, QPushButton, QTableWidget
...
class VentanaCaja(QWidget):
    def __init__(self):
        ...
        # Conectar el botón a la función de finalizar compra (placeholder)
